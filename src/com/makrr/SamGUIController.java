...
public class SamGUIController<T>
{
    ...
    private SamWorldFrame<T> parentFrame;
     ...
     */
    public SamGUIController(SamWorldFrame<T> parent, GridPanel disp,
                         DisplayMap displayMap, ResourceBundle res)
    {
        ...
        SamWorld<T> world = parentFrame.getWorld();
...
//            editLocation();
    ...
    public void editLocation()
    {
        ...
        if (loc != null)
        {
            ...
            if (occupant == null)
            {
                SamMenuMaker<T> maker = new SamMenuMaker<T>(parentFrame, resources,
                        displayMap);
