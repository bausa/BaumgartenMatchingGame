 ...
 * students.
 */
public class SamWorldFrame<T> extends JFrame
{
    private SamGUIController<T> control;
    private GridPanel display;
    private JTextArea messageArea;
    private ArrayList<JMenuItem> menuItemsDisabledDuringRun;
    private SamWorld<T> world;
     ...
     */
    public SamWorldFrame(SamWorld<T> world)
    {
        this.world = world;
        count++;
    ...
    private void makeNewGridMenu()
    {
        ...
        SamMenuMaker<T> maker = new SamMenuMaker<T>(this, resources, displayMap);
    ...
    public class GUIExceptionHandler
    {
        public void handle(Throwable e)
        {
            ...
            pane.createDialog(SamWorldFrame.this, e.toString()).setVisible(true);
